...
# Performance: 10.40s | Tokens: In=1662, Out=397
# Created At: 2026-01-28 12:53:53
...
def generate(level=1, **kwargs):
    # 隨機生成 abs_divisor_val 和 abs_quotient_val
    ...
    # 驗證條件
    if divisor == 0 or dividend % divisor != 0 or not (1 <= abs(result) <= 10) or (dividend > 0 and divisor > 0):
    ...
    question_text = f"計算下列各式的值。{question_math}"
