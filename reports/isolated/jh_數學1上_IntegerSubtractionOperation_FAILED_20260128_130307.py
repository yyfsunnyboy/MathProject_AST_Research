...
# Performance: 10.04s | Tokens: In=2312, Out=362
# Created At: 2026-01-28 13:03:07
...
def generate(level=1, **kwargs):
    ...
    def clean_latex_output(expr):
        return f"${expr}$"
    
    while True:
        sign_config = random.choice([('pos', 'pos'), ('pos', 'neg'), ('neg', 'pos'), ('neg', 'neg')])
    ...
    formatted_question = clean_latex_output(question_str)
