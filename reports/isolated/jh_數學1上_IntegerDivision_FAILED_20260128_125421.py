...
# Performance: 28.21s | Tokens: In=1519, Out=1140
# Created At: 2026-01-28 12:54:21
 ...
 ```json
{
  ...
  "operators": ["+", "-", "*", "/", "abs"],
  "constraints": [
    {"calculability": "All intermediate values and final answers must be precisely calculable integers."},
    {"boundary_conditions": [
      {"dividend_absolute_value_range": "-100~100"},
      {"divisor_absolute_value_range": "-12~12"},
      {"final_answer_absolute_value_range": "-10~10"}
    ]},
    {"mutual_exclusion": [
      {"non_zero_divisor": true},
      {"not_both_positive_numbers": true}
    ]},
    {"minimum_complexity": [
      {"two_integer_operands": true},
      {"at_least_one_negative_operand": true},
      {"integer_division_required": true}
    ]}
  ],
  "templates": [
    {
      ...
      "complexity_requirements": [
        ...
        {"final_answer_absolute_value_range_1_to_10": true}
      ],
      "variables": [
      ...
      "construction": [
        {"step_1": "Randomly generate abs_divisor_val (2~12) and abs_quotient_val (2~10)."},
        {"step_2": "Calculate abs_dividend_val = abs_divisor_val * abs_quotient_val."},
        {"step_3": "Randomly generate dividend_sign and divisor_sign."},
        {"step_4": "Ensure at least one sign is -1. If both are 1, regenerate one of them."},
        {"step_5": "Calculate dividend = dividend_sign * abs_dividend_val."},
        {"step_6": "Calculate divisor = divisor_sign * abs_divisor_val."},
        {"step_7": "Final answer: result = dividend / divisor (using Python's integer division `//` or `/` and ensuring the result is an integer)."}
      ],
      "implementation_checklist": [
        {"check_abs_divisor_val_and_quotient_val_range": true},
        {"check_correct_calculation_of_abs_dividend_val": true},
        {"ensure_at_least_one_sign_is_negative": true},
        {"correctly_calculate_dividend_and_divisor": true},
        {"ensure_non_zero_divisor": true},
        {"ensure_dividend_must_be_divisible_by_divisor": true},
        {"final_answer_absolute_value_range_1_to_10": true}
      ],
      "formatting": {
        "question_display": [
          {"use_fmt_num_for_negative_numbers": true},
          {"map_op_latex_slash": true},
          {"wrap_math_expression_with_clean_latex_output": true},
          {"concatenate_chinese_and_math_expression"}
        ],
        "answer_display": [
          {"final_answer_integer_string_conversion": true},
          {"example_str_result_to_minus_9": true},
          {"forbid_latex_format": true},
          {"forbid_fmt_num_usage": true}
        ]
      },
      "notes": [
        {"main_focus_on_sign_rules_in_integer_division": true},
        {"generate_negative_divided_by_positive": true},
        {"generate_negative_divided_by_negative": true},
        {"generate_positive_divided_by_negative": true},
        {"ensure_at_least_one_negative_operand_for_complexity": true}
      ]
    }
  ],
  "diversity": [
    ...
    {"value_size_variation": [
      {"random_adjustment_of_abs_divisor_val_and_quotient_val_range": true}
    ]},
    {"degeneration_check": [
      {"ensure_non_zero_divisor": true},
      {"ensure_dividend_must_be_divisible_by_divisor": true},
      {"ensure_at_least_one_negative_operand": true},
      {"avoid_final_answer_absolute_value_1": true}
    ]}
  ],
  "verifier": [
