...
# Performance: 97.71s | Tokens: In=4008, Out=410
# Created At: 2026-01-27 14:04:22
...
def generate(level=1, **kwargs):
    ...
    while math.gcd(n1, n2) != 1 or n2 > 20:
        n2 = random.randint(1, 20)
    
    n3 = random.randint(-1000, 1000)
    while n3 == 0:
        n3 = random.randint(-1000, 1000)
    ...
    if op1 == '/' and (n1 % n2 != 0 or n1 // n2 == 0):
        n1 *= n2
    if op2 == '/' and (n3 % n2 != 0 or n3 // n2 == 0):
        n3 *= n2
    
    final_result = Fraction(n1, n2)
    
    if op1 == '+':
        final_result += Fraction(n3, n2)
    elif op1 == '-':
        final_result -= Fraction(n3, n2)
    elif op1 == '*':
        final_result *= Fraction(n3, n2)
    ...
    question = f"${{fmt_num(Fraction(n1, n2)}, 'fraction')} {op_latex[op1]} {fmt_num(Fraction(n3, n2), 'fraction')}$"
    answer = fmt_num(final_result)
