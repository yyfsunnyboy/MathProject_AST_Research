...
# Performance: 36.24s | Tokens: In=2169, Out=1483
# Created At: 2026-01-28 11:34:18
...
def generate(level=1, **kwargs):
    ...
    json
    {
      ...
      "constraints": {
        ...
        "minimum_complexity": [
          "Must include two non-zero integers in subtraction operation.",
          "Must cover all positive-negative sign combinations (+,+; +,-; -,+; -,-).",
          "Final answer's absolute value should be greater than 0."
        ]
      },
      "templates": [
        {
          ...
          "implementation_checklist": [
            ...
            "- [ ] n1 and n2 are within specified value ranges (1~200 or -200~-1).",
            "- [ ] Ensured n1 and n2 do not both equal zero.",
            "- [ ] Randomly covered all four positive-negative sign combinations.",
            "- [ ] Directly calculated n1 - n2 using Python.",
            "- [ ] Checked and ensured final answer's absolute value is not 0.",
            "- [ ] Final answer within range of -400~400."
          ],
          "formatting": {
            "question_display": [
              "Formatting rules for the question:",
            ...
            "answer_display": [
              ...
              "- Prohibited from using LaTeX formatting or fmt_num()."
            ]
          },
          "notes": [
            "This template focuses on binary subtraction of integers, ensuring all positive-negative sign combinations are covered and avoiding overly simple problems (e.g., result is 0). Formatting rules particularly handle bracket display for negative numbers to follow common mathematical expression habits."
          ],
          "diversity": {
            "- Variation point 1: The size relationship between n1 and n2 can vary (e.g., |n1| > |n2|, |n1| < |n2|, |n1| = |n2|).",
            "- Variation point 2: The sign combinations of n1 and n2 must be randomly and evenly distributed to ensure all four cases (+,-, +,+ , -,+, -,-) appear.",
            "- Variation point 3: Value range can be slightly adjusted within value_range, such as sometimes generating smaller two-digit numbers, sometimes larger three-digit numbers."
          },
          "verifier": [
            "* After generation, verify:",
            "-- n1 and n2 are integers and meet their respective value_ranges.",
            "-- n1 and n2 do not both equal zero.",
            "-- Final calculation result 'result' is an integer within [-400, 400] range.",
            "-- abs(result) > 0.",
            "-- LaTeX format of the question stem is correct, especially bracket handling for negative numbers."
          ],
          "cross_domain_tools": {
            ...
            "- clean_latex_output: A generic function to wrap assembled mathematical expression strings with $ symbols for LaTeX rendering."
          }
        }
      ]
    }
