...
# Performance: 23.49s | Tokens: In=1736, Out=973
# Created At: 2026-01-28 11:35:26
...
def generate(level=1, **kwargs):
    ...
    - Integer ranges:
      - Factors: -10 to 10
      - Result: -100 to 100 (since the maximum product of two factors within the range is 10 * 10 = 100).
    ...
    - Minimum complexity:
      ...
      - Must cover all four combinations of positive and negative signs (positive x positive, positive x negative, negative x positive, negative x negative).

        - **integer_multiplication_two_factors**:
            - Complexity Requirements: 
                - Generate two non-zero integers as multipliers and multiplicands.
        - Use multiplication operation.
        - Ensure the generated problem covers all four sign combinations (positive x positive, positive x negative, negative x positive, negative x negative).
    ...
    - **factor2_sign**: Another boolean (True for positive, False for negative) randomly selected.
    ...
    4. Determine the value of `factor2` based on `factor2_abs` and `factor2_sign`.
    5. Calculate the final answer using Python's multiplication operator.
    6. Ensure the final answer is an integer within the expected range.
    ...
    - Ensure all four combinations of positive and negative signs are covered over time.
    ...
    - **Answer Display**:
      - Convert the final answer directly to a string without using LaTeX or `fmt_num()`.
        ...
        - The template focuses on basic integer multiplication concepts, especially handling positive and negative signs.
    - The automatic addition of parentheses for negative numbers by `fmt_num` is crucial for clarity.

        - **Variation 1**: Ensure all four combinations (positive x positive, positive x negative, negative x positive, negative x negative) are randomly generated.
    - **Variation 2**: Allow independent variation in the absolute values of both factors between 1 and 10.
    - **Degradation Check**:
      - Avoid generating problems with zero as a factor to prevent simple multiplication by zero.
    ...
    - The final answer is an integer within the range -100 to 100.
    - The mathematical expression in the question has correct formatting, with negative factors having proper parentheses.
    - The answer is displayed as a plain numeric string.

    This structured approach ensures that generated arithmetic problems are both educational and well-formatted for K12 students.
