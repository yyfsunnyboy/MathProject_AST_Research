...
# Performance: 9.34s | Tokens: In=1879, Out=345
# Created At: 2026-01-28 12:52:56
...
def generate(level=1, **kwargs):
    ...
    question_text = "計算下列各式的值。"
    question_text += clean_latex_output(fmt_num(factor1) + op_latex['*'] + fmt_num(factor2))
