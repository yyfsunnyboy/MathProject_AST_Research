...
# Performance: 27.46s | Tokens: In=1519, Out=1142
# Created At: 2026-01-28 11:36:35
...
def generate(level=1, **kwargs):
    ...
    json
    {
      ...
      "constraints": {
        ...
        "boundaries": [
          {"integer_range_generation": "|dividend| <= 100, |divisor| <= 12"},
          {"final_answer_range": "|quotient| <= 10"}
        ],
        "mutual_exclusion": [
          {"non_zero_divisor": true},
      ...
      "templates": [
        {
          ...
          "complexity_requirements": [
            {"two_integers": true},
            {"one_integer_operation": true},
            {"at_least_one_negative_number": true},
            {"dividend_divisible_by_divisor": true},
          ...
          "construction": [
            "Generate abs_divisor_val (2~12) and abs_quotient_val (2~10).",
            "Calculate abs_dividend_val = abs_divisor_val * abs_quotient_val.",
            "Generate dividend_sign and divisor_sign.",
            ...
            "Final answer: result = dividend / divisor (integer division)."
          ],
          "implementation_checklist": [
            {"correct_abs_divisor_and_quotient_range": true},
            {"correct_abs_dividend_calculation": true},
            {"at_least_one_negative_sign_ensured": true},
            {"correct_dividend_and_divisor_calculation": true},
            {"non_zero_divisor_ensured": true},
            {"dividend_divisible_by_divisor_ensured": true},
            {"final_answer_absolute_value_between_1_and_10_ensured": true}
          ],
          "formatting": {
            "question_display": [
              "Use fmt_num() to format dividend and divisor. Add parentheses for negative numbers.",
              "Map '/' to op_latex['/']",
              "Wrap mathematical expression with clean_latex_output().",
              "Concatenate Chinese text with the math expression."
            ],
            "answer_display": [
              "Final answer is an integer, convert directly to string.",
              "Example: str(result) → \"-9\"",
              "No LaTeX format allowed.",
              "Do not use fmt_num()."
            ]
          },
          "notes": [
            "This template mainly examines students' understanding of the sign rules in integer division.",
            ...
            "Ensure at least one is negative to meet the learning target."
          ]
        }
      ],
      "diversity": {
        "sign_combination_variation": [
          ...
          {"negative_divided_by_negative"},
          {"positive_divided_by_negative"}
        ],
        "value_size_variation": [
          {"random_adjustment_of_abs_divisor_and_quotient_range"}
        ],
        "degeneration_check": [
          {"non_zero_divisor_ensured"},
          {"dividend_divisible_by_divisor_ensured"},
          {"at_least_one_negative_operand_ensured"},
          {"final_answer_absolute_value_not_1_ensured"}
        ]
      },
      "verifier": {
        "post_generation_verification": [
          {"divisor_not_zero": true},
          {"dividend_modulo_divisor_equals_zero": true},
          {"result_is_integer": true},
          {"absolute_result_between_1_and_10": true},
          {"at_least_one_negative_operand": true}
        ]
      }
    }
