...
# Performance: 29.77s | Tokens: In=1519, Out=1205
# Created At: 2026-01-28 11:36:07
...
def generate(level=1, **kwargs):
    ...
    json
    {
      ...
      "entities": [
        ...
        },
        {
          ...
          "constraints": [
            {"value_range": "-12~12"},
            {"non_zero": true},
            {"must_be_divisor_of_dividend": true}
          ]
        },
        {
          "name": "quotient",
      ...
      "abs_function": "abs",
      "constraints": {
        "computability": "All intermediate values and final answers must be precisely calculable integers.",
        "boundaries": {
          "integer_range_generation": "The absolute value of dividend should not exceed 100, and the absolute value of divisor should not exceed 12.",
          "final_answer_range": "The absolute value of the final quotient should not exceed 10."
        },
        "mutual_exclusion": [
          {"divisor_not_zero": true},
          {"not_two_positive_numbers_division": true}
        ],
        "minimum_complexity": {
          "two_integer_operands": true,
          "at_least_one_negative_operand": true,
      ...
      "templates": [
        {
          ...
          "complexity_requirements": [
            {"two_integers": true},
            {"one_division_operation": true},
            {"at_least_one_negative_operand": true},
            {"dividend_must_be_divisible_by_divisor": true},
            {"final_answer_absolute_value_between_1_and_10": true}
          ],
          "variables": [
          ...
          "construction": [
            "Randomly generate abs_divisor_val (2~12) and abs_quotient_val (2~10).",
            "Calculate abs_dividend_val = abs_divisor_val * abs_quotient_val.",
            "Randomly generate dividend_sign and divisor_sign.",
            "Ensure at least one sign is -1. If both are 1, regenerate one of them.",
            "Calculate dividend = dividend_sign * abs_dividend_val.",
            "Calculate divisor = divisor_sign * abs_divisor_val.",
            "Final answer: result = dividend / divisor (use Python's integer division `//` or `/` and ensure the result is an integer)."
          ],
          "implementation_checklist": [
            {"correct_abs_divisor_and_quotient_values_generated": true},
            {"abs_dividend_calculated_correctly": true},
            {"at_least_one_sign_is_negative": true},
            {"dividend_and_divisor_calculated_correctly": true},
            {"divisor_not_zero": true},
            {"dividend_must_be_divisible_by_divisor": true},
            {"final_answer_absolute_value_between_1_and_10": true}
          ],
          "formatting": {
            "question_display": [
              "Use fmt_num() to format dividend and divisor. fmt_num() will automatically add parentheses for negative numbers.",
              "Use op_latex['/'] to map the division symbol.",
              "Wrap the mathematical expression part with clean_latex_output().",
              "Concatenate Chinese text with the mathematical expression."
            ],
            "answer_display": [
              "The final answer is an integer, directly converted to a string.",
              "Example: str(result) → \"-9\"",
              "Do not use LaTeX format.",
              "Do not use fmt_num()."
            ]
          },
          "notes": [
            "This template mainly examines students' understanding of the rules for positive and negative signs in integer division.",
            "By controlling the combination of dividend_sign and divisor_sign, it can generate:",
            "- Negative number ÷ Positive number (e.g., -63 ÷ 7)",
            "- Negative number ÷ Negative number (e.g., -72 ÷ -6)",
            "- Positive number ÷ Negative number (e.g., 81 ÷ -9)",
            "Ensure at least one is negative to meet the learning target of skill points."
          ]
        }
      ],
      "diversity": {
        "sign_combination_variation": [
          {"negative_divided_by_positive": true},
          {"negative_divided_by_negative": true},
          {"positive_divided_by_negative": true}
        ],
        "value_size_variation": "Control by randomly adjusting the range of abs_divisor_val and abs_quotient_val.",
        "degeneration_check": [
          {"divisor_not_zero": true},
          {"dividend_must_be_divisible_by_divisor": true},
          {"at_least_one_operand_negative": true},
          {"final_answer_absolute_value_not_1": true}
        ]
      },
      "verifier": {
        "post_generation_verification": [
          {"divisor_not_equal_to_zero": true},
          {"dividend_modulus_divisor_equals_zero": true},
          {"result_is_integer": true},
          {"abs_result_between_1_and_10": true},
          {"at_least_one_operand_negative": true}
        ]
      }
    }
