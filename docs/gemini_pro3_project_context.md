# 智學 Copilot (Smart-Edu Copilot) - 專案完整說明文件
...
### 核心定位
**智學 Copilot (Smart-Edu Copilot)** 是一個以「功文數學」教學理論為核心的 AI 驅動學習平台,專門針對「考不及格、數學較弱」的高中職學生設計,目標是透過手寫辨識、生成式 AI 分析與自適應題目推送,幫助學生打好基礎運算能力,達到及格門檻(60分)並建立學習信心。
