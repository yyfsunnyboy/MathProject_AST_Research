...
def generate(level=1, **kwargs):
    ...
    if level == 1:
        ...
        question_text = IntegerOps.format_latex(f'({IntegerOps.fmt_num(a)} \\times {IntegerOps.fmt_num(b)} - {IntegerOps.fmt_num(c)}) \\times {IntegerOps.fmt_num(d)} + {IntegerOps.fmt_num(e)} \\div {IntegerOps.fmt_num(f)} - {IntegerOps.fmt_num(g)} + {IntegerOps.fmt_num(h)} \\times {IntegerOps.fmt_num(i)} - {IntegerOps.fmt_num(j)} \\times {IntegerOps.fmt_num(k)} + {IntegerOps.fmt_num(l)} \\div {IntegerOps.fmt_num(m)} - {IntegerOps.fmt_num(n)} \\times {IntegerOps.fmt_num(o)} + {IntegerOps.fmt_num(p)} \\div {IntegerOps.fmt_num(q)} - {IntegerOps.fmt_num(r)} \\times {IntegerOps.fmt_num(s)} + {IntegerOps.fmt_num(t)} \\div {IntegerOps.fmt_num(u)} - {IntegerOps.fmt_num(v)} \\times {IntegerOps.fmt_num(w)} + {IntegerOps.fmt_num(x)} \\div {IntegerOps.fmt_num(y)} - {IntegerOps.fmt_num(z)}')
        answer = IntegerOps.safe_eval(question_text.replace('\\times', '*').replace('\\div', '/').replace('$$', '').replace('$$', ''))
